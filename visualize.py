...
def vis_one_image(
    ...
    for i in sorted_inds:
        ...
        if show_class:
            ax.text(
                ...
                fontsize=10,  # default font size of 3 is too small.
                family='serif',
                bbox=dict(
    ...
    Detectron processes each image using matplotlib.
    """
    # Visualize matplotlib figure
    img = convert_fig_to_numpy(fig)
    img = img[..., ::-1]

    cv2.imshow('some_img', img)
    cv2.waitKey(1)
    
    # Disabled Detectron default logic
